...
- **Security scanning**: Runs Trivy vulnerability scans on all builds
- **Multi-tagging**: Images tagged with latest, branch name, commit SHA, and semantic versions
- **Weekly builds**: Scheduled rebuilds for security updates
...
- Complete workflow setup and triggers
